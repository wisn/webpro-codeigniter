      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <h5>Sell Book</h5>
              <?php echo form_open('user/sell_book'); ?>
                <div class="form-group">
                  <small class="form-text text-muted">Title</small>
                  <input name="title" type="text" class="form-control" value="<?php if (isset($post['title'])) echo $post['title']; ?>" required>
                </div>
                <div class="form-group">
                  <small class="form-text text-muted">Author</small>
                  <input name="author" type="text" class="form-control" value="<?php if (isset($post['author'])) echo $post['author']; ?>" required>
                </div>
                <div class="row">
                  <div class="col-md-6 form-group">
                    <small class="form-text text-muted">Price</small>
                    <input name="price" type="text" class="form-control" value="<?php if (isset($post['price'])) echo $post['price']; ?>" required>
                  </div>
                  <div class="col-md-6 form-group">
                    <small class="form-text text-muted">Stock</small>
                    <input name="stock" type="text" class="form-control" value="<?php if (isset($post['stock'])) echo $post['stock']; ?>" required>
                  </div>
                </div>
